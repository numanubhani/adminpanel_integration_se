#!/bin/bash
# Remove specific commit 498bafe72aceb19c19f646ed8a554d66a4ca7b63 from git history
# This commit contains Twilio secrets that need to be removed
...
# Remove all files that contained secrets from entire git history
...
echo ""
read -p "Remove settings.py from history? (yes/no): " remove_settings
...
echo ""
echo "📋 Next steps:"
echo "1. Verify the commit is gone: git log --oneline | grep 498bafe"
